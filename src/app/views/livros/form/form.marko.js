...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Título:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"" +
    ...
    "\" placeholder=\"Coloque o nome do título\"> </div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" value=\"" +
    marko_escapeXmlAttr(data.livro.preco) +
    "\" placeholder=\"150.25\"> </div><div><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"Descrição do livro\">" +
